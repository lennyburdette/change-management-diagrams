  ...
  <TopologyContainer {lineConfigs} {boxConfigs}>
    <div class="relative grid topology gap-6 justify-center items-center">
      ...
      <div class="grid gap-2">
        <ServerPool id="gateway-blue" name="Gateway" cluster="Blue" schema="XY" code={0} />
        <ServerPool id="gateway-green" name="Gateway" cluster="Green" schema="XY" code={0} />
      </div>

      <div class="grid gap-2">
        <ServerPool id="subgraph-a" name="Subgraph A" schema="X" code={1} />
